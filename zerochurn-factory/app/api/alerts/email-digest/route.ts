...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const subject = `[ZeroChurn] Daily Portfolio Health Digest - ${new Date().toLocaleDateString()}`
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Sent by ZeroChurn • <a href="${baseUrl}/settings/notifications">Manage notifications</a></p>
    </div>
  </div>
</body>
</html>
