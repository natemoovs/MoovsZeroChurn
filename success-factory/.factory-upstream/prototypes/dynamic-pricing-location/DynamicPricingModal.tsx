...
const tokens = {
  ...
  shadows: {
    ...
    modalStrong:
      "0px 2px 4px -0.8px rgba(24,39,75,0.04), 0px 12px 14px -2px rgba(24,39,75,0.04), 0px 32px 40px -2.5px rgba(24,39,75,0.02)",
  },
}
...
const RadioButton: React.FC<RadioButtonProps> = ({ selected, label, onChange, name }) => (
  ...
  >
    ...
    <span style={{ ...tokens.typography.body2, color: tokens.colors.black }}>{label}</span>
  </label>
)
    ...
    >
      <div style={{ padding: "24px" }}>
        ...
        {savedRule && (
          ...
          >
            <h3 style={{ ...tokens.typography.h4, marginBottom: "8px" }}>Saved Rule:</h3>
            <pre
              style={{
                ...tokens.typography.body2,
                backgroundColor: "#F5F5F5",
