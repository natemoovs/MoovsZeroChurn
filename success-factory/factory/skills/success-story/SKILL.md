...
- @knowledge/success-factory/csm-playbook.md - For authentic customer voice
...
_[Note: This draft requires customer approval before publication. Verify all metrics and quotes directly with the customer.]_
```
