# Shuttle Platform Segments — CSM Guide

Shuttle customers have fundamentally different needs than Black Car — per-seat bookings, fixed routes, program-based relationships. This guide covers University, Corporate, and Operator variations.
...
- **High ridership** — Students actively using the system
- **"Where's my bus?" solved** — Real-time tracking live
- **Administration happy** — Safety reports, compliance metrics
- **Renewal secured** — Multi-year preferred
- **Expanding routes** — Adding services over time
...
- New campus/satellite location
- Athletics program shuttle need
- Late-night safety shuttle
- Commuter lot expansion
...
- **Employee adoption** — High ridership rates
- **HR/Facilities champion engaged** — Sees value in retention
- **ESG reporting** — Using sustainability metrics
- **Expanding programs** — Adding routes, times, locations
...
## Operator Shuttle (Third-Party)

### What Success Looks Like

- **Contracts managed in Moovs** — Multi-client operation
- **Client reporting automated** — SLA tracking
- **Margin visibility** — Understanding profitability
- **Winning new contracts** — Using Moovs as differentiator
...
1. **Think program, not product** — Success is program success
2. **Multiple stakeholders** — Admin, riders, drivers all matter
3. **Long cycles** — Prepare for annual RFP rhythms
4. **Data is everything** — Reports and metrics drive renewal
5. **Reference customers** — Peer validation critical for RFPs
