...
Renewals should be formalities, not negotiations. If you've done the work throughout the year, renewal is just paperwork.

---

## Renewal Goals

1. **Retain the customer** — Minimum viable outcome
2. **Expand the contract** — Grow revenue
3. **Secure multi-year** — Reduce churn risk
4. **Strengthen relationship** — Deeper partnership
...
### Scenario 1: Healthy Customer, Standard Renewal
...
**Expansion opportunity:** Yes — plant seeds or propose

### Scenario 2: Healthy Customer, Expansion Opportunity
...
4. Bundle pricing if helpful

**Key:** Don't separate renewal and expansion — bundle

### Scenario 3: At-Risk Customer, Want to Retain
...
### Scenario 5: Competitor Evaluation
...
### 60 Days Out: Renewal Summary

```
Subject: Your Moovs year in review — renewal coming up

Hey [Name],

Your renewal is coming up on [date]. Before we discuss terms, I wanted to share what you accomplished this year:

**Your highlights:**
- [X] trips processed through Moovs
- $[Y] revenue through the platform
- [Z] hours saved on dispatch (estimated)
- [Notable win]

**What's next:**
I'd love to schedule a quick call to discuss renewal and your plans for next year. Would [date/time] work?

[calendly link]
```

### 30 Days Out: Formal Proposal

```
Subject: [Company] renewal proposal — action needed by [date]

Hi [Name],

Attached is your renewal proposal for [term]. Quick summary:

- Term: [X months/years]
- Rate: $[X]/month
- What's included: [summary]

Based on our conversation, I've also included [expansion item] for your consideration.

Please review and let me know if you have questions. I'll need a signed agreement by [date] to ensure no service interruption.

[Signature link or attachment]
```

### 14 Days Out: Follow-Up

```
Subject: Renewal reminder — need your signature

Hey [Name],

Quick reminder that your renewal is due [date]. I haven't received the signed agreement yet.

Any questions or concerns I can address? Happy to jump on a quick call if helpful.
