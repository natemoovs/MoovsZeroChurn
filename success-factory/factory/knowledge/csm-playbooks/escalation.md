...
When things go wrong, how you respond defines the relationship. Great escalation handling creates loyalty. Poor handling accelerates churn.
...
4. Determine if workaround exists
...
Impact: [Business impact on customer]
Timeline: Customer needs resolution by [time/date]
...
Customer: [Name] | $[ARR] | [Segment]

Situation: [What's happening]
Impact: [Business risk - churn, expansion loss, etc.]
...
I just saw this and I'm sorry you're dealing with [issue]. I understand it's impacting [specific impact].

I'm escalating this internally right now. You'll hear from me with an update by [time].
...
What we know: [Explanation of issue]
What we're doing: [Current actions]
ETA: [Best estimate for resolution]

I'll update you again by [time] or sooner if we resolve it.
...
Good news — [issue] is resolved. Here's what happened and what we did:

Root cause: [Brief explanation]
Fix: [What we changed]
Prevention: [What we're doing to prevent recurrence]

Can you confirm everything is working on your end?

Apologies again for the disruption. I appreciate your patience.
```

### Follow-Up (24-48 Hours Later)

```
Subject: Checking in on [Issue]

Hey [Name],

Wanted to follow up — is everything still working as expected since [fix]?

Also, I've flagged [prevention measure] internally so this doesn't happen again.
...
## Difficult Escalation Scenarios

### Scenario: It's Our Fault
...
After a significant escalation, rebuild the relationship:

### Within 1 Week

- Personal call (not email)
- Check stability
...
- Health check call
- Ensure no lingering issues
- Look for quick wins to deliver

### At Next QBR

- Reference the incident
- Show prevention measures taken
- Celebrate recovery
